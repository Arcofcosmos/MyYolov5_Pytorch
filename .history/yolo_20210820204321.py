...
LastEditTime: 2021-08-20 20:43:21
LastEditors: TuZhou
Description: 
...
class YOLO(object):
    _defaults = {
        "model_path"        : './trained_model/yolov5_wzry.pth',
        ...
        "iou"               : 0.3,
        "cuda"              : True,
        "model_cfg_path"    :'./nets/yolov5s.yaml'
        #---------------------------------------------------------------------#
    ...
    def generate(self):
        ...
        #   建立yolov4模型
        #---------------------------------------------------#
        self.net = YoloBody(yaml_path = model_cfg_path, number_anchors = len(anchors[0]), gw = gw).eval()

...
LastEditTime: 2021-08-19 13:05:56
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\CSPDarknet53.py
'''
...
class CSP2(nn.Module): 
    def __init__(self, in_channels, out_channels, number_block, groups=1, gw=0.5):  
        ...
        self.convBlock = nn.ModuleList([CBL(c_, c_, kernel_size = 1), CBL(c_, c_, kernel_size = 3)]) * len(number_block)
        self.conv2 = nn.Sequential(*self.convBlock)

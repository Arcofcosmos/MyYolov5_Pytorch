...
LastEditTime: 2021-08-19 16:22:24
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\yolov5.py
'''
...
class YoloBody(nn.Module):
    ...
    def forward(self, x):
        ...
        #经过head部分装换结果输出通道维度
        out0 = nn.Conv2d(self.filters_info[5][0], self.result_channels, 1, 1)
        out1 = nn.Conv2d(self.filters_info[7][0], self.result_channels, 1, 1)
        out2 = nn.Conv2d(self.filters_info[9][0], self.result_channels, 1, 1)

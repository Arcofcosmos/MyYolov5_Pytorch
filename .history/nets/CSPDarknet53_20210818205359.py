...
LastEditTime: 2021-08-18 20:53:59
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\CSPDarknet53.py
'''
...
class CSPDarknet(nn.Module):
    def __init__(self, number_blocks, number_filters):
        super().__init__()
        
        #self.focus = Focus(in_channels, out_channels, kernel_size=1, stride=1, pad=None, groups=1, act=True)
...
def preprocess_backbone(pretrained, **kwargs):
    ...
    model = CSPDarknet(number_blocks, filters_info)

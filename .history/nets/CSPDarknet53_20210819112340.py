...
LastEditTime: 2021-08-19 11:23:40
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\CSPDarknet53.py
'''
...
class Focus(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, pad=None, groups=1, act=True): 
        super().__init__()
        self.conv = CBL(in_channels, out_channels, kernel_size=1, stride=1, pad=None, groups=1, act=True)
...
class CSPDarknet(nn.Module):
    def __init__(self, image_channel, number_blocks, filters_info):
        ...
        self.block3 = CSP1(filters_info[5][0], filters_info[6][0], number_blocks = number_blocks[2])

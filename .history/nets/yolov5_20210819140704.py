...
LastEditTime: 2021-08-19 14:07:04
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\yolov5.py
'''
...
class YoloBody(nn.Module):
    def __init__(self, cfg='yolov5s.yaml', image_channels=3, nc=None, anchors=None):  # model, input channels, number of classes
        ...
        self.conv1 = CBL(self.in_channel, self.filters_info[0][1], self.filters_info[0][2], self.filters_info[0][3])
        self.upsample = nn.Upsample(scale_factor=self.filter_info[1][1], mode=self.filters_info[1][2])

...
LastEditTime: 2021-08-20 16:23:31
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\nets\yolov5.py
'''
...
class YoloBody(nn.Module):
    def __init__(self, yaml_path='./nets/yolov5s.yaml', number_classes=None, number_anchors=3, gw = 0.5):  
        super().__init__()
        #---------------------------------------------------#   
        #   生成CSPdarknet53的主干模型
        #   以输入为608x608的图片为例
        #   获得三个有效特征层，他们的shape分别是(yolov5s)：
        #   76,76,128
        #   38,38,256
        #   19,19,512
        #---------------------------------------------------#
        self.backbone = preprocess_backbone(None)
        self.in_channel = int(1024 * gw)

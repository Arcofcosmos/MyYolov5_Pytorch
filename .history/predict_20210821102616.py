...
Author: TuZhou
Version: 1.0
Date: 2021-08-20 13:37:28
LastEditTime: 2021-08-21 10:26:16
LastEditors: TuZhou
Description: 
FilePath: \my_yolov5\predict.py
'''
#----------------------------------------------------#
...
if __name__ == "__main__":
    ...
    # music_path = "E:\\user\\python\\my_yolov4\\yolov4-pytorch-master\\video\\wzry.mp3"
    # video.write_audiofile('./video/wzry.mp3')
    # v1 = "E:\\user\\python\\my_yolov4\\yolov4-pytorch-master\\video\\wzry_output.mp4"
    # v2 = 'E:\\user\\python\\my_yolov4\\yolov4-pytorch-master\\video\\out_music.mp4'
    # cmd=f'ffmpeg -i {v1} -i {music_path} -codec copy {v2}'
    ...
    video_save_path = "./video/voc_output.mp4"
    video_fps       = 25.0
